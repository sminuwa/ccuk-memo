    ...
    <div class="row layout-top-spacing">
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <div class="widget-content widget-content-area br-6">
                ...
                <h4 class="table-header mb-4">My Payslip (<span class="text-danger">{{ $user->fullName() }}</span>)</h4>
                                ...
                                <div class="tab-pane fade @if($loop->first) show active @endif" id="tab{{ $year }}" role="tabpanel" aria-labelledby="v-border-pills-home-tab">
                                    <ul class="list-group">
                                        ...
                                        <li class="list-group-item">
                                            <a target="_blank" href="{{ route('payroll.staff.show-payslip',[$month->date->format('Y-m'),$user->id]) }}"><i class="las la-book mr-3 font-17"></i>{{ $month->date->format('F') }}</a>
                                        </li>
                                        @endforeach
                                    </ul>
                                </div>
